...
public class MessaggioDiAlert {

    private MessaggioDiAlert(){/*Costruttore privato*/}

    public static Alert errore(String messaggio) {
    ...
    public static Alert informazione(String titolo, String intestazione, String messaggio) {
    ...
    public static Integer avvertenza(String messaggio) {
