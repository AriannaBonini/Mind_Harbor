...
public class ControllerGraficoListaTestCLI extends AbsGestoreInput {
    ...
    private void scegliTest(int indice) {
        ...
        ControllerGraficoSvolgiTestCLI controllerGraficoSvolgiTestCLI= new ControllerGraficoSvolgiTestCLI();
        controllerGraficoSvolgiTestCLI.setControllerApplicativo(prescriviTerapiaController);
        controllerGraficoSvolgiTestCLI.setParametri(listaTest.get(opzione));
        controllerGraficoSvolgiTestCLI.start();
    }
